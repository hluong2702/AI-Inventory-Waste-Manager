        ...
        <section className="md:col-span-5 bg-sage-dark p-8 text-white md:p-10">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-widest text-white/85">Staff access</p>
            </div>
          </div>
        ...
        <main className="md:col-span-7 flex items-center p-6 md:p-10">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-5">
            <div>
              ...
              <p className="mt-1 text-sm text-ink/75">Dùng chung cho Owner, Manager và Staff.</p>
            </div>
            ...
            <label className="block">
              ...
              {errors.email && <span role="alert" className="mt-1 block text-xs text-terracotta">{errors.email.message}</span>}
            </label>
            ...
            <label className="block">
              ...
              <span className="mt-1.5 flex items-center gap-2 rounded-xl border border-ink/10 bg-offwhite/50 px-3">
                ...
                <input type="password" autoComplete="current-password" {...register('password')} className="w-full bg-transparent py-3 text-sm outline-none" />
              </span>
              {errors.password && <span role="alert" className="mt-1 block text-xs text-terracotta">{errors.password.message}</span>}
            </label>
